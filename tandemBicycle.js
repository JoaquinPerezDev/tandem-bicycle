...
//time complexity: O(nLog(n)) is a result of sorting both input arrays before
//looping through the arrays comparing values. This condenses down to nLog(n)
//time complexity.

//space complexity: Similarly to minimum wait time algorithm, we're iterating
// in constant space requiring no additional space besides the inputs we're
